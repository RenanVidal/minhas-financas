                ...
                <div class="p-6 text-gray-900">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    <a href="{{ route('transactions.show', $transaction) }}" class="text-blue-600 hover:text-blue-900">Ver</a>
                    ...
                    @else
                        <div class="text-center py-8">
                            <p class="text-gray-500 text-lg mb-4">Nenhuma transação encontrada.</p>
                            <a href="{{ route('transactions.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
